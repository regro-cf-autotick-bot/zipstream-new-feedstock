...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/zipstream-new-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14406&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/zipstream-new-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `zipstream-new` can be installed with:

```
conda install zipstream-new
```

It is possible to list all of the versions of `zipstream-new` available on your platform with:
